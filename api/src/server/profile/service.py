...
class ProfileService(object):
    ...
    def create(data):
        ...
        if ProfileDao.find_by_account_id(profile.account_id): raise DuplicateAccountException
        
        # Check for duplicate username
        if ProfileDao.find_by_username(profile.username): raise DuplicateUsernameException
