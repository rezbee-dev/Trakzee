...
class Register(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return {"message": f"{account.email} registered successfully"}, 201
...
class Login(Resource):
    ...
    @AccountRouter.response(404, "User does not exist")
    def post(self):
        req = request.get_json()
        ...
        try:
            ...
            AccountRouter.abort(404, "User does not exist")
        except Exception:
            AccountRouter.abort(500, "Unexcepted error, server cannot handle request")
...
class Account(Resource):
    ...
    #             account = AccountService.get_account_by_token({"token": access_token})
    #             return account, 200
